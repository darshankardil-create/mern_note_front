...
const Valueofsave = ({
  ...
  return (
    <div>
      ...
      >
        <div className="card bg-primary text-primary-content lg:w-120 lg:h-70 left-[10%] lg:left-[30%] mx-auto absolute top-1/3 w-85">
          <div className="card-body">
            <textarea
              ...
              placeholder="Title"
              className=" h-8 rounded-lg text-centers  focus:ring-3 focus:outline-none   focus:ring-blue-500 border border-gray-300 placeholder-amber-300"
            />
